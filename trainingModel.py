...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            '''we are dropping them becoz these columns were just telling if false then next column ke same row mein "?" hoga joki nan hai , but  we are using knn imputer so no need to use this info where its nan or not'''
